        ...
        stage('CloudGuard_Shiftleft_IaC') {
            ...
            steps {
                ...
                sh '''
                    ...
                    shiftleft iac-assessment --path aws  S3Bucket -l aws_cloudtrail should not have getResource('aws_s3_bucket',s3_bucket_name) contain [acl = 'public-read-write' or acl = 'public-read'] --environmentId ec00ab44-b2a5-4d4d-9746-ffaa110dd3b4 || if ["$?" == "6" ]; then exit 0 ; fi
                '''
            }
        }
