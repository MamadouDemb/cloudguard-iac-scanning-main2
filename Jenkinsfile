        ...
        stage('CloudGuard_Shiftleft_IaC') {
            ...
            steps {
                ...
                sh '''
                    ...
                    shiftleft iac-assessment --Infrastructure-Type terraform --path aws --ruleset -46 --severity-level High  --environmentId ec00ab44-b2a5-4d4d-9746-ffaa110dd3b4 || if ["$?" == "6" ]; then exit 0 ; fi
                '''
            }
        }
